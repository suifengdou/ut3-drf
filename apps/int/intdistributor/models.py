...
class ContactMode(models.Model):
    ...
    name = models.CharField(max_length=150, verbose_name='联系模式', help_text='联系模式')
...
class IntDistributor(models.Model):
    ...
    d_id = models.CharField(unique=True, max_length=60, db_index=True, null=True, blank=True, verbose_name='经销商ID', help_text='经销商ID')
    ...
    nationality = models.CharField(max_length=60, verbose_name='国别', help_text='国别')
    ...
    salesmen = models.ManyToManyField(User, blank=True, verbose_name='业务员', help_text='业务员')
    contacts = models.ManyToManyField(Contacts, blank=True, verbose_name='联系人', help_text='联系人')
